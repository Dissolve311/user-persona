module.exports = [{
  ...
  painpoints: ["Can't sing if IEMs having trouble", "Facial expression control on stage","Performance anxiety","Outside disruptions" ],
  products: ["Microphones", "IEMs", "Wedges"],
  responsibilities:
...

{
  ...
  about: {
    ...
    experience: "22 years",
    education: "College",
    skills: "system design, training and educating, trouble shooting",
  },
  ...
  products: [
    "3D acoustic simulation system","wireless system",
  ],
  responsibilities:
    "Quotes review, technical design of the sound system including PA, mics, wireless and more, onsite/offsite technical support ",
  software: "",
